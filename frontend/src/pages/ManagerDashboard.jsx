  ...
  return (
    <div className="animate-fade-in">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-extrabold text-text-primary tracking-tight">Manager Dashboard</h1>
          <p className="text-text-secondary mt-1">Manage employees and assign tasks.</p>
        </div>
